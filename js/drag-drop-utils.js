...
class DragDropUtils {
    ...
    setupStateDropZones() {
        ...
        // Add event listeners
        mapContainer.addEventListener('dragenter', this.handleMapDragEnter.bind(this));
        mapContainer.addEventListener('dragover', this.handleMapDragOver.bind(this));
    ...
    handleMapDrop(e) {
        ...
        if (dragData === 'rally-token') {
            ...
            if (targetStateId) {
                window.dispatchEvent(new CustomEvent('rallyDrop', {
    ...
    setupSVGDropZones() {
        ...
        if (svgElement) {
            svgElement.addEventListener('dragover', this.handleSVGDragOver.bind(this));
            svgElement.addEventListener('dragenter', this.handleSVGDragEnter.bind(this));
