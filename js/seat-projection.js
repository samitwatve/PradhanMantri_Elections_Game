...
class SeatProjection {
    ...
    setupEventListeners() {
      ...
      updateProjection() {
        ...
        // Log the projection
        console.log(`Seat projection updated - P1: ${totalP1Seats}, P2: ${totalP2Seats}, Others: ${totalOthersSeats}`);
    ...
    updateProgressBars(p1Seats, p2Seats, othersSeats) {
      ...
      analyzeParliamentComposition(p1Seats, p2Seats, othersSeats) {
        ...
        window.dispatchEvent(new CustomEvent('parliamentStatusChanged', {
            detail: { 
                status, 
                description,
