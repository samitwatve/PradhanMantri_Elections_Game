...
class PopularityInitializer {
     ...
     */    async initializeStatePopularity() {
        ...
        console.log(`Using home states - Player 1: ${player1HomeState}, Player 2: ${player2HomeState}`);
        ...
        this.statesData.forEach(state => {
            ...
            console.log(`- ${state.State} (SvgId: ${state.SvgId}) - P1 Home: ${isP1Home}, P2 Home: ${isP2Home}`);
        });
        ...
        console.log(`Allocated ${player2LeadingSeats} seats to Player 2 in ${player2LeadingStates.size} states`);        // Generate popularity scores for all states
        ...
        for (const state of this.statesData) {
            ...
            if (initialPopularity.player1 !== finalPopularity.player1 || 
                initialPopularity.player2 !== finalPopularity.player2) {
                console.log(`%cHome state bonus applied for ${state.State}`, 'color: gold; font-weight: bold');
                console.log(`Initial: P1=${initialPopularity.player1}%, P2=${initialPopularity.player2}%, Others=${initialPopularity.others}%`);
                console.log(`After bonus: P1=${finalPopularity.player1}%, P2=${finalPopularity.player2}%, Others=${finalPopularity.others}%`);
            }
